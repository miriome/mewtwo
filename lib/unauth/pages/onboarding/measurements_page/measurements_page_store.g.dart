...
part of 'measurements_page_store.dart';
...
mixin _$MeasurementsPageStore on _MeasurementsPageStore, Store {
  late final _$heightAtom =
      Atom(name: '_MeasurementsPageStore.height', context: context);
  ...
  late final _$bustAtom =
      Atom(name: '_MeasurementsPageStore.bust', context: context);
  ...
  late final _$waistAtom =
      Atom(name: '_MeasurementsPageStore.waist', context: context);
  ...
  late final _$hipsAtom =
      Atom(name: '_MeasurementsPageStore.hips', context: context);
