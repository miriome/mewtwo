                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: textFieldDecoration(context: context, labelText: "Password").copyWith(
                      ...
                      }, icon: Icon(store.isPasswordFieldVisible ? Icons.visibility : Icons.visibility_off, size: 28, color: const Color(0xFF7D7878),)),
                      error: !store.isPasswordValidated ? Text.rich(TextSpan(
                        children: [
